# Brief de marca — Driza SHANG INVERSIONES

> Fuente de verdad de todos los agentes. Los claims marcados ✅ están impresos en la etiqueta del producto (comprobables). Completa los campos entre corchetes que falten.

## Marca
- **Nombre:** SHANG INVERSIONES
- **Lema:** Calidad · Confianza · Progreso
- **Identidad visual:** etiqueta blanca con azul marino y dorado/cobre; monograma "SI" en círculo dorado.
- **Logotipo:** ya existe (etiqueta del producto). Archivo: `[RUTA/URL DEL LOGO]`

## Producto: DRIZA — "Máxima resistencia"
...
- Para el revendedor: marca con presentación profesional que no genera devoluciones y hace que el cliente vuelva.
- Para el mayorista: producto de rotación diaria (consumible de trabajo) con marca que invierte en publicidad.
